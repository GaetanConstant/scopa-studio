...
export const content = {
    hero: {
        title: "Bureaux partagés & Coworking \n Scopa Studio",
    ...
    services: {
        title: "Services inclus dans votre location",
        items: [
            { icon: "🤝", title: "Salle de réunion", desc: "Une salle de réunion pour vos rendez-vous d’équipe, ainsi que deux salles d’appels isolées pour vos visios." },
            { icon: "☕", title: "Cuisine équipée", desc: "Espaces de rangement, réfrigérateur, micro-ondes, bouilloire et machine à café à votre disposition." },
            { icon: "🥐", title: "Café / thé à volonté", desc: "Un allié discret mais précieux pour garder le cap… et partager une pause avec vos voisins coworking." },
            { icon: "🔐", title: "Accès sécurité 24/7", desc: "Passez quand vous voulez, restez aussi tard que nécessaire : vos bureaux sont sécurisés." },
    ...
    pricing: {
        ...
        description: "Travailler ensemble, ça n’a pas de prix… enfin si, le voici.",
        items: [
